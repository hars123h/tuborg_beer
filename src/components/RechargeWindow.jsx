    ...
    return (
        <div className='sm:h-[700px] md:h-[950px] flex flex-col gap-4  bg-white relative'>
            ...
            <div className='flex flex-col gap-4 p-8'>
                ...
                <div className='font-bold text-xl text-cyan-400'>UPI Information</div>
                <div className="box flex rounded-lg p-6 flex-col mt-3 bg-cyan-400 text-white">
                    <div className='text-md'>Payment Amount</div>
                    <div className='text-4xl'>&#8377; {recharge_value}</div>
                </div>

                <div className='font-bold text-xl text-cyan-400'>Payment Via UPI</div>
                <div className="step_one flex flex-col gap-1">
                    <div className='text-md'>1.Copy UPI information</div>
                    <div className='flex rounded-md items-center justify-between gap-2  p-2 border-2 border-cyan-400'>
                        <div className='text-cyan-400 font-bold'>{amountDetails.upi_id}</div>
                        <CopyToClipboard text={`${amountDetails.upi_id}`} onCopy={() => toaster('Copied to clipboard')}>
                        <div className='text-lg font-bold text-cyan-400 cursor-pointer'>Copy</div>
                </CopyToClipboard>
                ...
                <div className='flex rounded-md justify-between gap-2 text-cyan-400  p-2 border-2 border-cyan-400'>
                ...
                <div className="small_info text-sm font-extrabold  underline text-cyan-400">
                ...
                <button onClick={handleRecharge} className='bg-cyan-400 text-white p-4 rounded-lg text-lg shadow-lg shadow-gray-400'>Submit</button>
