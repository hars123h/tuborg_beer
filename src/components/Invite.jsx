...
const Invite = () => {
    ...
    return (
        <div className=' bg-red-800 h-[1000px] flex flex-col text-white font-light p-5 relative'>
            ...
            https://www.okinawscoter.online/register/invite_code/{userDetails.user_invite}
            </p>
            ...
            <div className="qr mx-auto flex justify-center items-center">
                <QRCode
                    ...
                    value={`https://www.okinawscoter.online/register/invite_code/${userDetails.user_invite}`}
                    viewBox={`0 0 120 120`}
                />
            </div>
